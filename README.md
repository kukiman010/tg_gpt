...
голосовой ввод сделать больше 30 сек
генерацию аудио сделать больше 2500 символов
сделать функцию update лакальных переменных default_data
когда кидают файлы в бота, нужно сделать так что бы все файлы преобразовывались в текст 
