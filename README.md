...
- [ ] При тестовой оплате не начислять тариф, а выдавать сообщение о тестировании платежной системы
- [ ] Добавить возможность выбора преобразовывать вывод к markdown или нет. 
- [ ] исправить ошибку с конфликтом имен при загрузке файла
- [ ] 
